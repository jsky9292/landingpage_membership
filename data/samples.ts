...
export const samplePages: SamplePage[] = [
  ...
  {
    id: 'personal-bankruptcy-sample',
    category: 'legal',
    categoryName: '법률/전문',
    name: '개인회생/파산',
    theme: 'slate',
    themeColor: '#64748B',
    description: '개인회생·파산 전문 상담',
    thumbnail: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=600&fit=crop',
    preview: {
      headline: '빚에서 벗어나는 법적 해결책',
      subtext: '개인회생·파산 전문 변호사 무료 상담',
      cta: '무료 상담 신청',
      badge: '성공보수제',
    },
    formData: {
      title: '개인회생/파산 상담',
      content: '빚에서 벗어나는 법적 해결책이 있습니다. 개인회생·파산 전문 변호사가 무료로 상담해드립니다. 채무 최대 90% 탕감, 성공보수제로 부담 없이 시작하세요.',
    },
    sections: [
      { id: 's1', type: 'hero', order: 0, content: { badge: '⚖️ 무료 상담 | 성공보수제', headline: '빚에서 벗어나는\n법적 해결책', subtext: '개인회생·파산 전문 변호사 상담.\n채무 최대 90% 탕감 가능', cta: '무료 상담 신청' } },
      { id: 's2', type: 'pain', order: 1, content: { title: '이런 고민 있으신가요?', items: [{ icon: '💳', text: '카드빚, 대출금이 눈덩이처럼 불어나고 있나요?' }, { icon: '📞', text: '독촉 전화에 시달리고 계신가요?' }, { icon: '🏠', text: '압류, 가압류 걱정되시나요?' }, { icon: '😰', text: '매달 이자만 내고 있으신가요?' }] } },
      { id: 's3', type: 'solution', order: 2, content: { title: '법적 해결책이 있습니다', headline: '개인회생·파산 전문', description: '3,000건 이상 성공 경험', items: [{ icon: '📉', title: '개인회생', description: '채무 최대 90% 탕감' }, { icon: '🔄', title: '개인파산', description: '면책으로 새출발' }, { icon: '🛡️', title: '압류 방지', description: '법적 보호 조치' }] } },
      { id: 's4', type: 'benefits', order: 3, content: { title: '상담 안내', items: [{ icon: '💰', title: '무료', description: '초기 상담 비용' }, { icon: '📊', title: '성공보수제', description: '결과에 따른 비용' }, { icon: '🔒', title: '비밀 보장', description: '철저한 보안 유지' }] } },
      { id: 's5', type: 'process', order: 4, content: { title: '진행 절차', steps: [{ number: 1, title: '무료 상담', description: '채무 현황 파악 및 방향 제시' }, { number: 2, title: '서류 준비', description: '필요 서류 안내 및 수집' }, { number: 3, title: '신청서 제출', description: '법원 신청서 작성 및 접수' }, { number: 4, title: '면책 결정', description: '인가 결정 후 새출발' }] } },
      { id: 's6', type: 'philosophy', order: 5, content: { title: '의뢰인 후기', quote: '카드빚 8천만원이 개인회생으로 월 30만원씩 3년만 내면 끝이에요. 독촉 전화도 바로 멈추고, 마음의 짐을 덜었습니다. 무료 상담받길 정말 잘했어요.', author: '이OO 님 (40대)', role: '개인회생 인가 / 채무 80% 탕감' } },
      { id: 's7', type: 'cta', order: 6, content: { headline: '무료 상담 받으세요', subtext: '빚 문제, 혼자 고민하지 마세요', buttonText: '무료 상담 신청' } },
      { id: 's8', type: 'form', order: 7, content: { title: '상담 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
      { id: 'debt', label: '총 채무액', type: 'select', required: true, options: ['3천만원 미만', '3천~5천만원', '5천만~1억원', '1억원 이상'] }
    ],
  },
  {
    id: 'corporate-bankruptcy-sample',
    category: 'legal',
    categoryName: '법률/전문',
    name: '법인회생/파산',
    theme: 'midnight',
    themeColor: '#1E3A5F',
    description: '법인회생·파산 전문 상담',
    thumbnail: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&h=600&fit=crop',
    preview: {
      headline: '기업 위기, 법적 해결책이 있습니다',
      subtext: '법인회생·파산 전문 변호사 상담',
      cta: '무료 상담 신청',
      badge: '기업 전문',
    },
    formData: {
      title: '법인회생/파산 상담',
      content: '기업 위기, 법적 해결책이 있습니다. 법인회생으로 회사를 살리거나, 법인파산으로 정리할 수 있습니다. 경영난, 자금난 겪는 기업을 위한 전문 상담.',
    },
    sections: [
      { id: 's1', type: 'hero', order: 0, content: { badge: '🏢 기업 전문 | 긴급 상담', headline: '기업 위기\n법적 해결책이 있습니다', subtext: '법인회생으로 회사를 살리거나\n법인파산으로 깔끔하게 정리', cta: '긴급 상담 신청' } },
      { id: 's2', type: 'pain', order: 1, content: { title: '이런 상황이신가요?', items: [{ icon: '💸', text: '자금난으로 월급, 거래대금 지급이 어려우신가요?' }, { icon: '🏦', text: '은행 대출 연체, 압류 위기에 처하셨나요?' }, { icon: '📉', text: '매출 급감으로 경영난을 겪고 계신가요?' }, { icon: '⚠️', text: '부도 위기에 몰리셨나요?' }] } },
      { id: 's3', type: 'solution', order: 2, content: { title: '기업을 위한 법적 해결책', headline: '법인회생·파산 전문', description: '100개 이상 기업 구조조정 경험', items: [{ icon: '🔄', title: '법인회생', description: '채무 조정 후 정상화' }, { icon: '📋', title: '법인파산', description: '깔끔한 정리·청산' }, { icon: '🛡️', title: '긴급 보전', description: '압류·가압류 방어' }] } },
      { id: 's4', type: 'benefits', order: 3, content: { title: '상담 안내', items: [{ icon: '🏢', title: '기업 전문', description: '법인 전담 변호사' }, { icon: '⏰', title: '긴급 대응', description: '24시간 상담 가능' }, { icon: '🔒', title: '비밀 보장', description: '철저한 보안 유지' }] } },
      { id: 's5', type: 'process', order: 4, content: { title: '진행 절차', steps: [{ number: 1, title: '긴급 상담', description: '현황 파악 및 방향 결정' }, { number: 2, title: '전략 수립', description: '회생/파산 전략 설계' }, { number: 3, title: '법원 신청', description: '신청서 작성 및 접수' }, { number: 4, title: '절차 진행', description: '인가/면책까지 대리' }] } },
      { id: 's6', type: 'philosophy', order: 5, content: { title: '의뢰인 후기', quote: '부도 직전이었는데, 법인회생 신청으로 회사를 살렸습니다. 채무 50% 탕감받고, 10년 분할상환으로 정상화됐어요. 포기하지 않길 잘했습니다.', author: '박OO 대표 (제조업)', role: '법인회생 인가 / 정상화 성공' } },
      { id: 's7', type: 'cta', order: 6, content: { headline: '긴급 상담 받으세요', subtext: '기업 위기, 전문가와 해결책을 찾으세요', buttonText: '긴급 상담 신청' } },
      { id: 's8', type: 'form', order: 7, content: { title: '상담 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '담당자명', type: 'text', placeholder: '이름을 입력하세요', required: true },
  ...
  {
    id: 'insurance-adjuster-sample',
    category: 'legal',
    categoryName: '법률/전문',
    name: '손해사정',
    theme: 'toss',
    themeColor: '#0064FF',
    description: '보험금 청구 전문',
    thumbnail: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=600&fit=crop',
    preview: {
      headline: '보험금, 제대로 받고 계신가요?',
      subtext: '손해사정사가 정당한 보험금을 찾아드립니다',
      cta: '무료 상담 신청',
      badge: '성공보수제',
    },
    formData: {
      title: '손해사정 상담',
      content: '보험금, 제대로 받고 계신가요? 손해사정사가 정당한 보험금을 찾아드립니다. 교통사고, 상해, 질병, 화재 등 모든 보험 사고 전문. 성공보수제로 부담 없이 상담하세요.',
    },
    sections: [
      { id: 's1', type: 'hero', order: 0, content: { badge: '📋 무료 상담 | 성공보수제', headline: '보험금\n제대로 받고 계신가요?', subtext: '손해사정사가 정당한 보험금을 찾아드립니다.\n평균 보험금 2.3배 증액 실적', cta: '무료 상담 신청' } },
      { id: 's2', type: 'pain', order: 1, content: { title: '이런 경험 있으신가요?', items: [{ icon: '💰', text: '보험금이 생각보다 적게 나왔나요?' }, { icon: '❌', text: '보험금 청구가 거절당했나요?' }, { icon: '🤔', text: '보험사 산정 금액이 맞는지 모르겠나요?' }, { icon: '📄', text: '서류 준비가 복잡하고 어려우신가요?' }] } },
      { id: 's3', type: 'solution', order: 2, content: { title: '정당한 보험금을 찾아드립니다', headline: '손해사정 전문', description: '5,000건 이상 보험금 증액 실적', items: [{ icon: '🚗', title: '교통사고', description: '자동차 보험금 청구' }, { icon: '🏥', title: '상해/질병', description: '실비, 진단비 청구' }, { icon: '🔥', title: '화재/재해', description: '재산 피해 보상' }] } },
      { id: 's4', type: 'benefits', order: 3, content: { title: '서비스 안내', items: [{ icon: '📊', title: '평균 2.3배', description: '보험금 증액 실적' }, { icon: '💰', title: '성공보수제', description: '증액분의 일부만' }, { icon: '📋', title: '서류 대행', description: '모든 서류 처리' }] } },
      { id: 's5', type: 'process', order: 4, content: { title: '진행 절차', steps: [{ number: 1, title: '무료 상담', description: '사고 내용 및 보험 확인' }, { number: 2, title: '분석', description: '보상 가능 금액 산정' }, { number: 3, title: '청구', description: '서류 준비 및 청구 대행' }, { number: 4, title: '보상', description: '보험금 수령 및 정산' }] } },
      { id: 's6', type: 'philosophy', order: 5, content: { title: '의뢰인 후기', quote: '교통사고로 보험사에서 500만원 제시받았는데, 손해사정 맡기니까 1,500만원 받았어요. 성공보수라 부담도 없었고, 서류도 다 대행해주셔서 편했습니다.', author: '최OO 님 (30대)', role: '교통사고 / 보험금 3배 증액' } },
      { id: 's7', type: 'cta', order: 6, content: { headline: '무료 상담 받으세요', subtext: '정당한 보험금, 전문가가 찾아드립니다', buttonText: '무료 상담 신청' } },
      { id: 's8', type: 'form', order: 7, content: { title: '상담 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
      { id: 'type', label: '사고 유형', type: 'select', required: true, options: ['교통사고', '상해/질병', '화재/재해', '기타'] }
    ],
  },
  {
    id: 'labor-attorney-sample',
    category: 'legal',
    categoryName: '법률/전문',
    name: '노무사',
    theme: 'warm',
    themeColor: '#059669',
    description: '노동 문제 전문 상담',
    thumbnail: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=800&h=600&fit=crop',
    preview: {
      headline: '부당해고, 임금체불 당하셨나요?',
      subtext: '공인노무사가 노동자의 권리를 지켜드립니다',
      cta: '무료 상담 신청',
      badge: '노동청 신고 대행',
    },
    formData: {
      title: '노무사 상담',
      content: '부당해고, 임금체불 당하셨나요? 공인노무사가 노동자의 권리를 지켜드립니다. 해고, 임금, 퇴직금, 산재, 직장 내 괴롭힘 등 모든 노동 문제 상담.',
    },
    sections: [
      { id: 's1', type: 'hero', order: 0, content: { badge: '👷 무료 상담 | 노동청 신고 대행', headline: '부당해고, 임금체불\n당하셨나요?', subtext: '공인노무사가 노동자의 권리를 지켜드립니다.\n해고, 임금, 퇴직금, 산재 전문', cta: '무료 상담 신청' } },
      { id: 's2', type: 'pain', order: 1, content: { title: '이런 상황이신가요?', items: [{ icon: '🚪', text: '갑자기 해고 통보를 받으셨나요?' }, { icon: '💸', text: '월급, 퇴직금을 못 받고 계신가요?' }, { icon: '😢', text: '직장 내 괴롭힘을 당하고 계신가요?' }, { icon: '🏥', text: '일하다 다쳤는데 산재 처리가 안 되나요?' }] } },
      { id: 's3', type: 'solution', order: 2, content: { title: '노동자의 권리를 지켜드립니다', headline: '노무사 전문 상담', description: '15년 경력 공인노무사', items: [{ icon: '🚪', title: '부당해고', description: '복직 또는 금전 보상' }, { icon: '💰', title: '임금체불', description: '밀린 임금 전액 수령' }, { icon: '🏥', title: '산재', description: '산업재해 보상 청구' }] } },
      { id: 's4', type: 'benefits', order: 3, content: { title: '서비스 안내', items: [{ icon: '💰', title: '무료', description: '초기 상담 비용' }, { icon: '📋', title: '신고 대행', description: '노동청 신고 대리' }, { icon: '⚖️', title: '소송 대리', description: '노동위 심판 대리' }] } },
      { id: 's5', type: 'process', order: 4, content: { title: '진행 절차', steps: [{ number: 1, title: '무료 상담', description: '사안 파악 및 방향 결정' }, { number: 2, title: '증거 수집', description: '근로계약서, 급여명세 등' }, { number: 3, title: '노동청 신고', description: '진정서 작성 및 제출' }, { number: 4, title: '구제', description: '복직, 임금 수령, 보상' }] } },
      { id: 's6', type: 'philosophy', order: 5, content: { title: '의뢰인 후기', quote: '5개월치 월급을 못 받고 퇴사했는데, 노무사님이 노동청 신고 대행해주셔서 밀린 임금 전액 + 지연이자까지 받았어요. 혼자 했으면 못 받았을 거예요.', author: '김OO 님 (20대)', role: '임금체불 / 전액 수령 성공' } },
      { id: 's7', type: 'cta', order: 6, content: { headline: '무료 상담 받으세요', subtext: '노동자의 권리, 전문가가 찾아드립니다', buttonText: '무료 상담 신청' } },
      { id: 's8', type: 'form', order: 7, content: { title: '상담 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
      { id: 'type', label: '상담 유형', type: 'select', required: true, options: ['부당해고', '임금체불', '퇴직금', '산재', '직장 내 괴롭힘', '기타'] }
    ],
  },
  {
    id: 'criminal-lawyer-sample',
    category: 'legal',
    categoryName: '법률/전문',
    name: '형사전문 변호사',
    theme: 'dark',
    themeColor: '#374151',
    description: '형사사건 전문 변호',
    thumbnail: 'https://images.unsplash.com/photo-1479142506502-19b3a3b7ff33?w=800&h=600&fit=crop',
    preview: {
      headline: '형사사건, 초기 대응이 중요합니다',
      subtext: '검찰 출신 변호사가 함께합니다',
      cta: '긴급 상담 신청',
      badge: '검찰 출신',
    },
    formData: {
      title: '형사전문 변호사',
      content: '형사사건, 초기 대응이 중요합니다. 검찰 출신 변호사가 수사 단계부터 재판까지 함께합니다. 사기, 폭행, 음주운전, 성범죄 등 전 분야 형사 변호.',
    },
    sections: [
      { id: 's1', type: 'hero', order: 0, content: { badge: '⚖️ 검찰 출신 | 24시간 긴급 대응', headline: '형사사건\n초기 대응이 중요합니다', subtext: '검찰 출신 변호사가 수사 단계부터 함께합니다.\n고소당한 순간, 지금 바로 연락하세요', cta: '긴급 상담 신청' } },
      { id: 's2', type: 'pain', order: 1, content: { title: '이런 상황이신가요?', items: [{ icon: '🚔', text: '경찰 조사를 받게 되셨나요?' }, { icon: '📋', text: '고소장을 받으셨나요?' }, { icon: '⚠️', text: '검찰 소환 통지를 받으셨나요?' }, { icon: '😰', text: '구속될까봐 걱정되시나요?' }] } },
      { id: 's3', type: 'solution', order: 2, content: { title: '검찰 출신 변호사가 함께합니다', headline: '형사 전문 변호', description: '20년 경력, 1,000건 이상 수임', items: [{ icon: '🔍', title: '수사 대응', description: '경찰/검찰 조사 동행' }, { icon: '⚖️', title: '재판 변호', description: '공판 준비 및 변론' }, { icon: '🛡️', title: '구속 방어', description: '구속영장 기각' }] } },
      { id: 's4', type: 'benefits', order: 3, content: { title: '상담 안내', items: [{ icon: '👔', title: '검찰 출신', description: '수사 전략 수립' }, { icon: '⏰', title: '24시간', description: '긴급 대응 가능' }, { icon: '🔒', title: '비밀 보장', description: '철저한 보안 유지' }] } },
      { id: 's5', type: 'process', order: 4, content: { title: '진행 절차', steps: [{ number: 1, title: '긴급 상담', description: '사건 내용 파악' }, { number: 2, title: '전략 수립', description: '변호 방향 결정' }, { number: 3, title: '조사 대응', description: '경찰/검찰 조사 동행' }, { number: 4, title: '재판 변호', description: '무죄/감형 변론' }] } },
      { id: 's6', type: 'philosophy', order: 5, content: { title: '의뢰인 후기', quote: '사기죄로 고소당해서 막막했는데, 변호사님이 수사 단계부터 함께해주셔서 불기소 처분 받았습니다. 검찰 출신이라 수사 전략이 달랐어요. 빨리 연락드리길 잘했습니다.', author: '박OO 님 (50대)', role: '사기 혐의 / 불기소 처분' } },
      { id: 's7', type: 'cta', order: 6, content: { headline: '긴급 상담 받으세요', subtext: '형사사건, 초기 대응이 결과를 바꿉니다', buttonText: '긴급 상담 신청' } },
      { id: 's8', type: 'form', order: 7, content: { title: '상담 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
      { id: 'type', label: '사건 유형', type: 'select', required: true, options: ['사기', '폭행/상해', '음주운전', '성범죄', '횡령/배임', '기타'] }
    ],
  },
  // 생활서비스
  {
