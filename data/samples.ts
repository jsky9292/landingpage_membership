...
export const samplePages: SamplePage[] = [
  ...
  // 의료/건강
  {
    ...
    sections: [
      ...
      { id: 's3', type: 'solution', order: 2, content: { title: '걱정 없이 시술 받으세요', headline: '무통 임플란트 전문', description: '20년 경력 전문의가 책임집니다', items: [{ icon: '💉', title: '무통 시술', description: '수면/무통 마취로 편안하게' }, { icon: '🛡️', title: '10년 보증', description: '무상 A/S 보증' }, { icon: '💳', title: '36개월 무이자', description: '부담 없는 분할 결제' }] } },
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 상담 예약하세요', subtext: '첫 방문 CT + 상담 50% 할인', buttonText: '상담 예약하기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '상담 예약', buttonText: '예약하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 's3', type: 'solution', order: 2, content: { title: '전문의 1:1 맞춤 시술', headline: '최신 레이저 장비', description: '피부 타입에 맞는 맞춤 시술', items: [{ icon: '🔬', title: '정밀 진단', description: '피부 상태 정밀 분석' }, { icon: '💎', title: '맞춤 시술', description: '1:1 맞춤 치료 계획' }, { icon: '🛡️', title: '사후 관리', description: '시술 후 케어 프로그램' }] } },
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 피부 상담 받으세요', subtext: '신규 고객 첫 시술 30% 할인', buttonText: '상담 예약하기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '상담 예약', buttonText: '예약하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 체질 진단 받으세요', subtext: '상담만 받아도 체질별 식단표 증정', buttonText: '체질 진단 예약' } },
      { id: 's6', type: 'form', order: 5, content: { title: '체질 진단 예약', buttonText: '예약하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
  ...
  // 보험 세부 샘플
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 비교 견적 받으세요', subtext: '비교만 해도 커피 쿠폰 증정', buttonText: '보험료 비교하기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '보험료 비교', buttonText: '비교하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 상담 신청하세요', subtext: '부담 없이 상담만 받아보세요', buttonText: '상담 신청하기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '상담 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 실비 진단받으세요', subtext: '진단만 받아도 보험 체크리스트 증정', buttonText: '실비 진단받기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '실비 진단 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 보험 상담받으세요', subtext: '상담만 받아도 육아용품 증정', buttonText: '보험 상담받기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '보험 상담 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 's6', type: 'cta', order: 5, content: { headline: '입사 상담 신청하세요', subtext: '부담 없이 조건만 확인해보세요', buttonText: '입사 상담 신청' } },
      { id: 's7', type: 'form', order: 6, content: { title: '입사 상담 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
  ...
  // 뷰티/미용
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '지금 예약하세요', subtext: '첫 방문 고객 20% 할인', buttonText: '예약하기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '예약 신청', buttonText: '예약하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '지금 예약하세요', subtext: '신규 고객 30% 할인', buttonText: '예약하기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '예약 신청', buttonText: '예약하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
  ...
  // 법률/전문서비스
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 법률 상담 받으세요', subtext: '부담 없이 문의하세요', buttonText: '무료 상담 신청' } },
      { id: 's6', type: 'form', order: 5, content: { title: '상담 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
  ...
  // 생활서비스
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 견적받으세요', subtext: '방문 견적 무료 | 비교 후 결정', buttonText: '무료 견적받기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '견적 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '견적 문의하세요', subtext: '당일 예약 가능 | 만족 보장', buttonText: '견적 문의하기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '견적 문의', buttonText: '문의하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
  ...
  // 웨딩/사진
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 상담 받으세요', subtext: '상담만 받아도 웨딩 체크리스트 증정', buttonText: '무료 상담 예약' } },
      { id: 's6', type: 'form', order: 5, content: { title: '상담 예약', buttonText: '예약하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
  ...
  // 반려동물
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '진료 예약하세요', subtext: '24시간 응급 진료 가능', buttonText: '진료 예약하기' } },
      { id: 's6', type: 'form', order: 5, content: { title: '진료 예약', buttonText: '예약하기' } }
    ],
    formFields: [
  ...
  // 학원/교육
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 체험 레슨 신청하세요', subtext: '부담 없이 체험 후 결정하세요', buttonText: '무료 체험 신청' } },
      { id: 's6', type: 'form', order: 5, content: { title: '체험 레슨 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 's5', type: 'cta', order: 4, content: { headline: '무료 레벨테스트 받으세요', subtext: '테스트 후 맞춤 커리큘럼 제안', buttonText: '레벨테스트 신청' } },
      { id: 's6', type: 'form', order: 5, content: { title: '레벨테스트 신청', buttonText: '신청하기' } }
    ],
    formFields: [
      { id: 'name', label: '이름', type: 'text', placeholder: '이름을 입력하세요', required: true },
      { id: 'phone', label: '연락처', type: 'tel', placeholder: '010-0000-0000', required: true },
